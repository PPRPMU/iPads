...
# Each form will have an index high enough that will not be affected by a line break issue. If statement checks if title of form is true. First form is Aquatics Audit Control.
        ...
        for j in all_districts:
            ...
            for i in j:
                for k in field_list:
                    ...
                    if i == k:
                        print "Facility is " + i
                        shutil.move(fileName, 'iPads/Aquatics/District ' + str(district_number))
                        # Rename file?
        ...
        for j in all_districts:
            ...
            for i in j:
                for k in field_list:
                    ...
                    if i == k:
                        print "Facility is " + i
                        shutil.move(fileName, 'iPads/SVR/District ' + str(district_number))
                        # Rename file?
